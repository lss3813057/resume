...
Bingo.prototype = {
    ...
    screenWidth: 1440,
    preloadFiles: {
        s1024: ["imgs/ink_dots_close_1024.png", "imgs/ink_dots_far_1024.png", "imgs/print_blue_1024.png",
                "imgs/print_blue_one_1024.png", "imgs/print_purple_1024.png", "imgs/print_red_1024.png",
                "imgs/person_1024.png", "imgs/skills_1024.png", "imgs/print_yellow_1024.png", "imgs/bg_1024.jpg"],
        s1440: ["imgs/ink_dots_close_1440.png", "imgs/ink_dots_far_1440.png", "imgs/print_blue_1440.png",
                "imgs/print_blue_one_1440.png", "imgs/print_purple_1440.png", "imgs/print_red_1440.png",
                "imgs/person_1440.png", "imgs/skills_1440.png", "imgs/print_yellow_1440.png", "imgs/bg_1440.jpg"],
        s1920: ["imgs/ink_dots_close_1920.png", "imgs/ink_dots_far_1920.png", "imgs/print_blue_1920.png",
                "imgs/print_blue_one_1920.png", "imgs/print_purple_1920.png", "imgs/print_red_1920.png",
                "imgs/person_1920.png", "imgs/skills_1920.png", "imgs/print_yellow_1920.png", "imgs/bg_1920.jpg"]
    },
    init: function () {
    ...
    preload: function () {
        var a = $(".loading"),
            ...
            d = c.preloadFiles,
            e = [];
        b > 1440 ? (e = d.s1920, b = 1920) : 1024 >= b ? (e = d.s1024, b = 1024) : (e = d.s1440, b = 1440), this.screenWidth =
            b, new Preload({
            fileArr: e,
            oneLoaded: function () {
                var b = this.percent;
    ...
    loadComplete: function () {
        var a = $("header"),
            ...
            f = d / e * 100 + "%",
            g = this;
        $("body").addClass("s" + this.screenWidth), a.css("height", f), b.css("opacity", 0), c.css("margin",
            "-35px 0 0 -76px"), setTimeout(function () {
...
Preload.prototype = {
    ...
    perpectiveMouse: function () {
        ...
        function d() {
            ...
            return a.each(function () {
                var a = $(this);
                a.data("maxRange", Number(a.data("perpective-mouse")) * g.maxRange), a.data("posLeft", parseFloat(a.css(
                    "left"))), a.data("posTop", parseFloat(a.css("top")))
            }), a
        }
        function e(a) {
            var b = {
    ...
    scrollAt: function (a, b) {
        if (a) {
            ...
            for (var j = 0, k = h.length; k > j; j++)(g - h[j].top > b && h[j].top >= f || h[j].bottom - f > b && h[j].bottom <=
                    g || h[j].top <= f && h[j].bottom >= g) && i.push(c(d[j]));
            return 0 === i.length && (h[0].top >= g - b ? i = ["top"] : h[h.length - 1].bottom <= f + b && (i = [
                    "bottom"])), i
        }
    }
});